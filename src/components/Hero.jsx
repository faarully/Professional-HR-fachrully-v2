...
>
  ...
  {/* UPDATE: Deskripsi dibuat melebar (w-full) dan tanpa max-width ketat */}
  <motion.p 
    initial={{ opacity: 0 }} 
    animate={{ opacity: 1 }} 
    transition={{ delay: 1, duration: 1.2 }} 
    className="w-full text-sm md:text-lg text-slate-500 dark:text-slate-400 mb-10 leading-relaxed font-medium text-center lg:text-justify tracking-tight"
  >
    {data['Deskripsi']}
  </motion.p>
